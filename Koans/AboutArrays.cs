...
namespace DotNetCoreKoans.Koans
{
    public class AboutArrays : Koan
    {
        ...
        public void SlicingArrays()
        {
            ...
            //TW- take is like a reverse skip AKA Take(2) means take the first two 
            //TW- skip will skip whatever its told- skip the first item and then "take" the next two
            //to the array
        }
        ...
        public void PushingAndPopping()
        {
           ...
           // Stack() = Initializes a new instance of the Stack class that is 
        ...
        public void Shifting()
        {
            ...
            //TW- Still do not fully understand this, will look in to/ask ?'s monday
        }
