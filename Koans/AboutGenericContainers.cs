...
namespace DotNetCoreKoans.Koans
{
    public class AboutGenericContainers : Koan
	{
		...
		public void StackPushPop()
		{
			...
			Assert.Equal(0, stack.Count); // TW- pop takes items out of the array
		}
		[Step(16)]
		...
		public void ModifyingData()
		{
			...
			dictionary["two"] = "dos";
			dictionary["one"] = "ein";
			Assert.Equal("ein", dictionary["one"]); //TW - why not uno? I am assuming the 2nd one overrides the first?
		}
		[Step(27)]
		...
		public void f()
		{
			...
			Assert.Equal(54, one["jim"]); //why is this 54 and not 53?
